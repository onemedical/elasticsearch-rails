...
ElasticsearchV2::Model.client = ElasticsearchV2::Client.new host: 'localhost:9200', log: true
...
# Article.__send__ :include, ElasticsearchV2::Model::Callbacks
...
# Index data
#
client = ElasticsearchV2::Client.new host:'localhost:9200', log:true
