module ElasticsearchV2
  module Model
    ...
    #
    # @see ElasticsearchV2::Model::Adapter::Default
    # @see ElasticsearchV2::Model::Adapter::ActiveRecord
    # @see ElasticsearchV2::Model::Adapter::Mongoid
    #
    module Adapter
      ...
      #
      #     myadapter = ElasticsearchV2::Model::Adapter.from_class(Article)
      #     myadapter.adapter
      #     # => ElasticsearchV2::Model::Adapter::ActiveRecord
      #
      ...
      #
      # @see ::ElasticsearchV2::Model::Adapter::Adapter.adapters
      #
      def adapters
        Adapter.adapters
      ...
      #
      # @see ::ElasticsearchV2::Model::Adapter::Adapter.register
      #
      ...
      class Adapter
        ...
        #     # => {
        #     #  ElasticsearchV2::Model::Adapter::ActiveRecord => #<Proc:0x007...(lambda)>,
        #     #  ElasticsearchV2::Model::Adapter::Mongoid => #<Proc:0x007... (lambda)>,
        #     # }
        #
        ...
        def adapter
          @adapter ||= begin
            ...
            || ElasticsearchV2::Model::Adapter::Default
          end
        end
