module ElasticsearchV2
  module Model
    module Adapter
      ...
      # retrieved through `ElasticsearchV2::Model.search`
      #
      # @see ElasticsearchV2::Model.search
      #
      module Multiple
        ...
        module Records
          ...
          def __records_for_klass(klass, ids)
            ...
            case
              when ElasticsearchV2::Model::Adapter::ActiveRecord.equal?(adapter)
                klass.where(klass.primary_key => ids)
              when ElasticsearchV2::Model::Adapter::Mongoid.equal?(adapter)
          ...
          #
          # @see ElasticsearchV2::Model::Registry
          #
          # @api private
          #
