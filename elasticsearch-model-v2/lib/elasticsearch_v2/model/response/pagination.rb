      ...
      module Pagination
        ...
        module Kaminari
          def self.included(base)
            ...
            #
            ElasticsearchV2::Model::Response::Results.__send__ :include, ::Kaminari::ConfigurationMethods::ClassMethods
            ElasticsearchV2::Model::Response::Results.__send__ :include, ::Kaminari::PageScopeMethods
            ElasticsearchV2::Model::Response::Records.__send__ :include, ::Kaminari::PageScopeMethods

            ElasticsearchV2::Model::Response::Results.__send__ :delegate, :limit_value, :offset_value, :total_count, :max_pages, to: :response
            ElasticsearchV2::Model::Response::Records.__send__ :delegate, :limit_value, :offset_value, :total_count, :max_pages, to: :response
        ...
        module WillPaginate
          def self.included(base)
            ...
            ElasticsearchV2::Model::Response::Results.__send__ :delegate, *methods, to: :response
            ElasticsearchV2::Model::Response::Records.__send__ :delegate, *methods, to: :response
          end
