...
module ElasticsearchV2
  module Model
    class ActiveRecordAssociationsIntegrationTest < ElasticsearchV2::Test::IntegrationTestCase
      ...
      context "ActiveRecord associations" do
        setup do
          ...
          Comment.__send__ :include, ElasticsearchV2::Model
          Comment.__send__ :include, ElasticsearchV2::Model::Callbacks
