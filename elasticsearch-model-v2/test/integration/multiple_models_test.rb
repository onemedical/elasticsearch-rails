...
module ElasticsearchV2
  module Model
    class MultipleModelsIntegration < ElasticsearchV2::Test::IntegrationTestCase
      module ::NameSearch
      ...
      context "Multiple models" do
        ...
        should "find matching documents across multiple models" do
          ...
          assert_instance_of ElasticsearchV2::Model::Response::Result, response.results.first
        ...
        should "provide access to results" do
          response = ElasticsearchV2::Model.search(%q<"A great Episode"^2 OR "A great Series">, [Series, Episode])
        ...
        should "paginate the results" do
          response = ElasticsearchV2::Model.search('series OR episode', [Series, Episode])
        ...
        if Mongo.available?
          ...
          context "Across mongoid models" do
            ...
            should "find matching documents across multiple models" do
              response = ElasticsearchV2::Model.search(%q<"greatest Episode" OR "greatest Image"^2>, [Episode, Image])
