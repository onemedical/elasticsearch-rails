...
class ElasticsearchV2::Model::AdapterActiveRecordTest < Test::Unit::TestCase
  context "Adapter ActiveRecord module: " do
    ...
    should "have the register condition" do
      assert_not_nil ElasticsearchV2::Model::Adapter.adapters[ElasticsearchV2::Model::Adapter::ActiveRecord]
      assert_equal false, ElasticsearchV2::Model::Adapter.adapters[ElasticsearchV2::Model::Adapter::ActiveRecord].call(DummyClassForActiveRecord)
    end

    context "Records" do
      setup do
        DummyClassForActiveRecord.__send__ :include, ElasticsearchV2::Model::Adapter::ActiveRecord::Records
      end

      should "have the implementation" do
        assert_instance_of Module, ElasticsearchV2::Model::Adapter::ActiveRecord::Records
    ...
    context "Callbacks" do
      should "register hooks for automatically updating the index" do
        ...
        ElasticsearchV2::Model::Adapter::ActiveRecord::Callbacks.included(DummyClassForActiveRecord)
      end
    end

    context "Importing" do
      setup do
        DummyClassForActiveRecord.__send__ :extend, ElasticsearchV2::Model::Adapter::ActiveRecord::Importing
      end
