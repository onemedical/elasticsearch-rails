...
class ElasticsearchV2::Model::AdapterDefaultTest < Test::Unit::TestCase
  context "Adapter default module" do
    class ::DummyClassForDefaultAdapter; end

    should "have the default Records implementation" do
      assert_instance_of Module, ElasticsearchV2::Model::Adapter::Default::Records

      DummyClassForDefaultAdapter.__send__ :include, ElasticsearchV2::Model::Adapter::Default::Records
    ...
    should "have the default Callbacks implementation" do
      assert_instance_of Module, ElasticsearchV2::Model::Adapter::Default::Callbacks
    end

    context "concerning abstract methods" do
      setup do
        DummyClassForDefaultAdapter.__send__ :include, ElasticsearchV2::Model::Adapter::Default::Importing
      end

      should "have the default Importing implementation" do
        assert_raise ElasticsearchV2::Model::NotImplemented do
