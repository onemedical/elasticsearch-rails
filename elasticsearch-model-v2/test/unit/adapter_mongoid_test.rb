...
class ElasticsearchV2::Model::AdapterMongoidTest < Test::Unit::TestCase
  context "Adapter Mongoid module: " do
    ...
    should "have the register condition" do
      assert_not_nil ElasticsearchV2::Model::Adapter.adapters[ElasticsearchV2::Model::Adapter::Mongoid]
      assert_equal false, ElasticsearchV2::Model::Adapter.adapters[ElasticsearchV2::Model::Adapter::Mongoid].call(DummyClassForMongoid)
    end

    context "Records" do
      setup do
        DummyClassForMongoid.__send__ :include, ElasticsearchV2::Model::Adapter::Mongoid::Records
      end

      should "have the implementation" do
        assert_instance_of Module, ElasticsearchV2::Model::Adapter::Mongoid::Records
    ...
    context "Callbacks" do
      should "register hooks for automatically updating the index" do
        ...
        ElasticsearchV2::Model::Adapter::Mongoid::Callbacks.included(DummyClassForMongoid)
      end
    end
    ...
    context "Importing" do
      should "implement the __find_in_batches method" do
        ...
        DummyClassForMongoid.__send__ :extend, ElasticsearchV2::Model::Adapter::Mongoid::Importing
