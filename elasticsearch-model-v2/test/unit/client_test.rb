...
class ElasticsearchV2::Model::ClientTest < Test::Unit::TestCase
  context "Client module" do
    class ::DummyClientModel
      extend  ElasticsearchV2::Model::Client::ClassMethods
      include ElasticsearchV2::Model::Client::InstanceMethods
    end

    should "have the default client method" do
      assert_instance_of ElasticsearchV2::Transport::Client, DummyClientModel.client
      assert_instance_of ElasticsearchV2::Transport::Client, DummyClientModel.new.client
    end
