...
class ElasticsearchV2::Model::IndexingTest < Test::Unit::TestCase
  context "Indexing module: " do
    class ::DummyIndexingModel
      extend ActiveModel::Naming
      extend ElasticsearchV2::Model::Naming::ClassMethods
      extend ElasticsearchV2::Model::Indexing::ClassMethods
    ...
    context "Settings class" do
      should "be convertible to hash" do
        hash     = { foo: 'bar' }
        settings = ElasticsearchV2::Model::Indexing::Settings.new hash
    ...
    context "Settings method" do
      should "initialize the index settings" do
        assert_instance_of ElasticsearchV2::Model::Indexing::Settings, DummyIndexingModel.settings
      end
    ...
    context "Mappings class" do
      should "initialize the index mappings" do
        assert_instance_of ElasticsearchV2::Model::Indexing::Mappings, DummyIndexingModel.mappings
      end

      should "raise an exception when not passed type" do
        assert_raise ArgumentError do
          ElasticsearchV2::Model::Indexing::Mappings.new
        end
      end

      should "be convertible to hash" do
        mappings = ElasticsearchV2::Model::Indexing::Mappings.new :mytype, { foo: 'bar' }
      ...
      should "define properties" do
        mappings = ElasticsearchV2::Model::Indexing::Mappings.new :mytype
    ...
    context "Instance methods" do
      ...
      should "register before_save callback when included" do
        ...
        ::DummyIndexingModelWithCallbacks.__send__ :include, ElasticsearchV2::Model::Indexing::InstanceMethods
      end
