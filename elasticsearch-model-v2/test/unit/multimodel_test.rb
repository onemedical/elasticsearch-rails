...
class ElasticsearchV2::Model::MultimodelTest < Test::Unit::TestCase
  ...
  context "Multimodel class" do
    setup do
      ...
      @multimodel = ElasticsearchV2::Model::Multimodel.new(title, series)
    end
    ...
    should "have a client" do
      assert_equal ElasticsearchV2::Model.client, @multimodel.client
    end
    ...
    should "include models in the registry" do
      ...
      multimodel = ElasticsearchV2::Model::Multimodel.new
