...
class ElasticsearchV2::Model::ResponseAggregationsTest < Test::Unit::TestCase
  context "Response aggregations" do
    ...
    should "access the aggregations" do
      ...
      assert_kind_of ElasticsearchV2::Model::Response::Aggregations, response.aggregations
