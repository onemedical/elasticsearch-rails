...
class ElasticsearchV2::Model::ResponsePaginationKaminariTest < Test::Unit::TestCase
  class ModelClass
  ...
  context "Response pagination" do
    ...
    setup do
      @search   = ElasticsearchV2::Model::Searching::SearchRequest.new ModelClass, '*'
      @response = ElasticsearchV2::Model::Response::Response.new ModelClass, @search, RESPONSE
    ...
    context "limit/offset readers" do
      ...
      should "return the value from URL parameters" do
        search    = ElasticsearchV2::Model::Searching::SearchRequest.new ModelClass, '*', size: 10, from: 50
        @response = ElasticsearchV2::Model::Response::Response.new ModelClass, search, RESPONSE
  ...
  context "Multimodel response pagination" do
    setup do
      @multimodel = ElasticsearchV2::Model::Multimodel.new(ModelClass)
      @search     = ElasticsearchV2::Model::Searching::SearchRequest.new @multimodel, '*'
      @response   = ElasticsearchV2::Model::Response::Response.new @multimodel, @search, RESPONSE
      @response.klass.stubs(:client).returns mock('client')
    end
