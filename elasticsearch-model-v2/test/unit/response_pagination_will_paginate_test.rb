...
class ElasticsearchV2::Model::ResponsePaginationWillPaginateTest < Test::Unit::TestCase
  class ModelClass
  ...
  class WillPaginateResponse < ElasticsearchV2::Model::Response::Response
    include ElasticsearchV2::Model::Response::Pagination::WillPaginate
  end
