...
class ElasticsearchV2::Model::RecordsTest < Test::Unit::TestCase
  context "Response records" do
    ...
    RESULTS  = ElasticsearchV2::Model::Response::Results.new DummyModel, RESPONSE

    setup do
      search   = ElasticsearchV2::Model::Searching::SearchRequest.new DummyModel, '*'
      search.stubs(:execute!).returns RESPONSE

      response = ElasticsearchV2::Model::Response::Response.new DummyModel, search
      @records = ElasticsearchV2::Model::Response::Records.new  DummyModel, response
    end
    ...
    context "with adapter" do
      ...
      should "delegate the records method to the adapter" do
        ...
        @records = ElasticsearchV2::Model::Response::Records.new DummyModel,
                                                               RESPONSE
