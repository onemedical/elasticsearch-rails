...
class ElasticsearchV2::Model::ResultTest < Test::Unit::TestCase
  context "Response result" do

    should "have method access to properties" do
      result = ElasticsearchV2::Model::Response::Result.new foo: 'bar', bar: { bam: 'baz' }
    ...
    should "return _id as #id" do
      result = ElasticsearchV2::Model::Response::Result.new foo: 'bar', _id: 42, _source: { id: 12 }
    ...
    should "return _type as #type" do
      result = ElasticsearchV2::Model::Response::Result.new foo: 'bar', _type: 'baz', _source: { type: 'BAM' }
    ...
    should "delegate method calls to `_source` when available" do
      result = ElasticsearchV2::Model::Response::Result.new foo: 'bar', _source: { bar: 'baz' }
    ...
    should "delegate existence method calls to `_source`" do
      result = ElasticsearchV2::Model::Response::Result.new foo: 'bar', _source: { bar: { bam: 'baz' } }
    ...
    should "delegate methods to @result" do
      result = ElasticsearchV2::Model::Response::Result.new foo: 'bar'
    ...
    should "delegate existence method calls to @result" do
      result = ElasticsearchV2::Model::Response::Result.new foo: 'bar', _source: { bar: 'bam' }
      assert_respond_to result, :foo?
