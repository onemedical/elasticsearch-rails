...
class ElasticsearchV2::Model::ResponseTest < Test::Unit::TestCase
  context "Response" do
    class OriginClass
    ...
    should "load and access the results" do
      ...
      response = ElasticsearchV2::Model::Response::Response.new OriginClass, @search
      assert_instance_of ElasticsearchV2::Model::Response::Results, response.results
    ...
    should "load and access the records" do
      ...
      response = ElasticsearchV2::Model::Response::Response.new OriginClass, @search
      assert_instance_of ElasticsearchV2::Model::Response::Records, response.records
      assert_equal 0, response.size
    end
    ...
    should "be initialized lazily" do
      ...
      ElasticsearchV2::Model::Response::Response.new OriginClass, @search
    end
