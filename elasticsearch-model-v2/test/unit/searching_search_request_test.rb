...
class ElasticsearchV2::Model::SearchRequestTest < Test::Unit::TestCase
  context "SearchRequest class" do
    class ::DummySearchingModel
      extend ElasticsearchV2::Model::Searching::ClassMethods
    ...
    should "pass the search definition as a simple query" do
      ...
      s = ElasticsearchV2::Model::Searching::SearchRequest.new ::DummySearchingModel, 'foo'
      s.execute!
    end
    ...
    should "pass the search definition as a Hash" do
      ...
      s = ElasticsearchV2::Model::Searching::SearchRequest.new ::DummySearchingModel, foo: 'bar'
      s.execute!
    end
    ...
    should "pass the search definition as an object which responds to to_hash" do
      ...
      s = ElasticsearchV2::Model::Searching::SearchRequest.new ::DummySearchingModel, MySpecialQueryBuilder.new
      s.execute!
    end
    ...
    should "pass the options to the client" do
      ...
      s = ElasticsearchV2::Model::Searching::SearchRequest.new ::DummySearchingModel, 'foo', size: 15
      s.execute!
    end
  end
end
