  ...
  module Persistence
    ...
    module Repository
      def self.included(base)
        gateway = ElasticsearchV2::Persistence::Repository::Class.new host: base
      ...
      def new(options={}, &block)
        ElasticsearchV2::Persistence::Repository::Class.new( {index: 'repository'}.merge(options), &block )
