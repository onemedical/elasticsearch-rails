...
module ElasticsearchV2
  module Persistence
    class PersistenceModelBasicIntegrationTest < ElasticsearchV2::Test::IntegrationTestCase

      class ::Person
        include ElasticsearchV2::Persistence::Model
        include ElasticsearchV2::Persistence::Model::Rails
      ...
      context "A basic persistence model" do
        ...
        should "save and find the object" do
          ...
          assert_not_nil ElasticsearchV2::Persistence.client.get index: 'people', type: 'human_being', id: person.id
        end
        ...
        should "delete the object" do
          ...
          assert_raise ElasticsearchV2::Transport::Transport::Errors::NotFound do
            ElasticsearchV2::Persistence.client.get index: 'people', type: 'person', id: person.id
          end
        end
        ...
        should "respect the version" do
          ...
          assert_raise ElasticsearchV2::Transport::Transport::Errors::Conflict do
