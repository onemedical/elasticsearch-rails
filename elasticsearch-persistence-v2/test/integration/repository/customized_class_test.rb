...
module ElasticsearchV2
  module Persistence
    class RepositoryCustomizedClassIntegrationTest < ElasticsearchV2::Test::IntegrationTestCase
      ...
      context "A custom repository class" do
        ...
        should "save the object under a correct index and type" do
          ...
          assert_not_nil ElasticsearchV2::Persistence.client.get index: 'my_notes', type: 'my_note', id: '1'
        end
        ...
        should "delete the object" do
          ...
          assert_raise(ElasticsearchV2::Persistence::Repository::DocumentNotFound) { @repository.find(1) }
        end
