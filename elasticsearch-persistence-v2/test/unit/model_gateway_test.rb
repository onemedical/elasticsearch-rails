...
require 'elasticsearch_v2/persistence/model/rails'

class ElasticsearchV2::Persistence::ModelGatewayTest < Test::Unit::TestCase
  context "The model gateway" do
    ...
    teardown do
      ElasticsearchV2::Persistence::ModelGatewayTest.__send__ :remove_const, :DummyGatewayModel \
      rescue NameError; nil
    end

    should "be accessible" do
      assert_instance_of ElasticsearchV2::Persistence::Repository::Class, DummyGatewayModel.gateway
    ...
    should "properly look up types for classes" do
      assert_equal 'string',  ElasticsearchV2::Persistence::Model::Utils::lookup_type(String)
      assert_equal 'integer', ElasticsearchV2::Persistence::Model::Utils::lookup_type(Integer)
      assert_equal 'float',   ElasticsearchV2::Persistence::Model::Utils::lookup_type(Float)
      assert_equal 'date',    ElasticsearchV2::Persistence::Model::Utils::lookup_type(Date)
      assert_equal 'boolean', ElasticsearchV2::Persistence::Model::Utils::lookup_type(Virtus::Attribute::Boolean)
    end
