...
class ElasticsearchV2::Persistence::ModelRailsTest < Test::Unit::TestCase
  context "The model in a Rails application" do
    ...
    should "parse DateTime from Rails forms" do
      ...
      assert_equal '2014-1-1- 12:00:',
                   ElasticsearchV2::Persistence::Model::Rails.__convert_rails_dates(params)['published_at']
    ...
    should "parse Date from Rails forms" do
      ...
      assert_equal '2014-1-1-',
             ElasticsearchV2::Persistence::Model::Rails.__convert_rails_dates(params)['published_on']
