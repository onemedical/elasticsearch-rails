...
class ElasticsearchV2::Persistence::ModelStoreTest < Test::Unit::TestCase
  context "The model store module," do
    ...
    teardown do
      ElasticsearchV2::Persistence::ModelStoreTest.__send__ :remove_const, :DummyStoreModelWithCallback \
