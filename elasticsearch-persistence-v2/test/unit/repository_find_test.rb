...
class ElasticsearchV2::Persistence::RepositoryFindTest < Test::Unit::TestCase
  class MyDocument; end

  context "The repository" do
    setup do
      @shoulda_subject = Class.new() { include ElasticsearchV2::Persistence::Repository::Find }.new
    ...
    context "'__find_one' method" do
      ...
      should "raise DocumentNotFound exception when the document cannot be found" do
        ...
        @client
          .expects(:get)
          .raises(ElasticsearchV2::Transport::Transport::Errors::NotFound)

        assert_raise ElasticsearchV2::Persistence::Repository::DocumentNotFound do
