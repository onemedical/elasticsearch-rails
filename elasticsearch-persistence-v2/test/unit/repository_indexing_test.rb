...
class ElasticsearchV2::Persistence::RepositoryIndexingTest < Test::Unit::TestCase
  context "The repository index methods" do
    class MyDocument; end

    setup do
      @shoulda_subject = Class.new() { include ElasticsearchV2::Model::Indexing::ClassMethods }.new
