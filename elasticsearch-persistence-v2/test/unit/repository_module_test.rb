...
class ElasticsearchV2::Persistence::RepositoryModuleTest < Test::Unit::TestCase
  context "The repository module" do
    ...
    teardown do
      ElasticsearchV2::Persistence::RepositoryModuleTest.__send__ :remove_const, :DummyRepository
    end
    ...
    context "when included" do
      should "set up the gateway for the class and instance" do
        ...
        assert_instance_of ElasticsearchV2::Persistence::Repository::Class, DummyRepository.gateway
        assert_instance_of ElasticsearchV2::Persistence::Repository::Class, DummyRepository.new.gateway
      end
    ...
    should "configure the index name in the shortcut initializer" do
      assert_equal 'repository', ElasticsearchV2::Persistence::Repository.new.index_name
    end
  end
end
