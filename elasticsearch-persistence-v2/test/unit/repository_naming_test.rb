...
class ElasticsearchV2::Persistence::RepositoryNamingTest < Test::Unit::TestCase
  context "The repository naming" do
    ...
    setup do
      @shoulda_subject = Class.new() { include ElasticsearchV2::Persistence::Repository::Naming }.new
    end
