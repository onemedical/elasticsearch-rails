...
class ElasticsearchV2::Persistence::RepositorySearchTest < Test::Unit::TestCase
  class MyDocument; end

  context "The repository search" do
    setup do
      @shoulda_subject = Class.new() { include ElasticsearchV2::Persistence::Repository::Search }.new
    ...
    should "search across all types" do
      ...
      assert_instance_of ElasticsearchV2::Persistence::Repository::Response::Results,
                         subject.search(foo: 'bar')
    end
    ...
    should "return the number of domain objects" do
      subject.expects(:search)
        .returns(ElasticsearchV2::Persistence::Repository::Response::Results.new( subject, {'hits' => { 'total' => 1 }}))
