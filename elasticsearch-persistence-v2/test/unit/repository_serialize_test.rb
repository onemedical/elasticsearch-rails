...
class ElasticsearchV2::Persistence::RepositorySerializeTest < Test::Unit::TestCase
  context "The repository serialization" do
    ...
    setup do
      @shoulda_subject = Class.new() { include ElasticsearchV2::Persistence::Repository::Serialize }.new
    end
