require 'elasticsearch_v2/rails/instrumentation/railtie'
...
module ElasticsearchV2
  module Rails
    ...
    #
    # @see ElasticsearchV2::Rails::Instrumentation::Publishers
    # @see ElasticsearchV2::Rails::Instrumentation::Railtie
    #
