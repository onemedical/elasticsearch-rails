    ...
    module Instrumentation
      ...
      module ControllerRuntime
        ...
        def cleanup_view_runtime
          elasticsearch_rt_before_render = ElasticsearchV2::Rails::Instrumentation::LogSubscriber.reset_runtime
          runtime = super
          elasticsearch_rt_after_render = ElasticsearchV2::Rails::Instrumentation::LogSubscriber.reset_runtime
        ...
        def append_info_to_payload(payload)
          super
          payload[:elasticsearch_runtime] = (elasticsearch_runtime || 0) + ElasticsearchV2::Rails::Instrumentation::LogSubscriber.reset_runtime
        end
