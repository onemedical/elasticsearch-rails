...
ELASTICSEARCH_V2_URL = ENV['ELASTICSEARCH_V2_URL'] || 'http://localhost:9200'

ElasticsearchV2::Model.client = ElasticsearchV2::Client.new host: ELASTICSEARCH_V2_URL
...
ElasticsearchV2::Model.client.transport.tracer = tracer
CODE
