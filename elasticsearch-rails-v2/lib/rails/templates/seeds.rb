...
Article.__elasticsearch_v2__.client.transport.tracer.level = Logger::INFO
Article.__elasticsearch_v2__.client.transport.tracer.formatter = lambda do |s, d, p, message|
